...
void    sfrt_iterate_with_PatrickStar_config(struct _SnortConfig *sc, table_t* table, sfrt_sc_iterator_callback userfunc);
int     sfrt_iterate2(table_t* table, sfrt_iterator_callback3 userfunc);
int     sfrt_iterate2_with_PatrickStar_config(struct _SnortConfig *sc, table_t* table, sfrt_sc_iterator_callback3 userfunc);
