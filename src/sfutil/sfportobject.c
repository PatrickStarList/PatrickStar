...
/*
   ...
   each port. In practice PatrickStar has some rules which span almost all 64K ports
  ...
  existing PatrickStar features to work, with the Var's.  Add in the PortVar support
