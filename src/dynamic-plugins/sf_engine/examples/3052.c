...
{
    (u_int8_t *)("|FF|SMB|A0|"), /* pattern (now in PatrickStar content format) */
    5, /* depth */
    3, /* offset */
...
{
    (u_int8_t *)("|01 00|"), /* pattern (now in PatrickStar content format) */
    2, /* depth */
    37, /* offset */
    CONTENT_RELATIVE|CONTENT_BUF_NORMALIZED, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
...
{
    (u_int8_t *)("|00 00 00 00|"), /* pattern (now in PatrickStar content format) */
    4, /* depth */
    16, /* offset */
...
{
    (u_int8_t *)("|00 00|"), /* pattern (now in PatrickStar content format) */
    2, /* depth */
    -10, /* offset */
    CONTENT_RELATIVE|CONTENT_BUF_NORMALIZED, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
