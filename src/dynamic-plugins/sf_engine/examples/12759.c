...
{
    (u_int8_t *)("63"), /* pattern (now in PatrickStar content format) */
    2, /* depth */
    0, /* offset */
...
{
    (u_int8_t *)("1"), /* pattern (now in PatrickStar content format) */
    1, /* depth */
    3, /* offset */
...
{
    (u_int8_t *)("3"), /* pattern (now in PatrickStar content format) */
    1, /* depth */
    3, /* offset */
