...
{
    (u_int8_t *)("|00|"), /* pattern (now in PatrickStar content format) */
    1, /* depth */
    0, /* offset */
...
{
    (u_int8_t *)("|FF|SMB%"), /* pattern (now in PatrickStar content format) */
    5, /* depth */
    3, /* offset */
...
{
    (u_int8_t *)("|5C|PIPE|5C 00|"), /* pattern (now in PatrickStar content format) */
    0, /* depth */
    4, /* offset */
...
{
    (u_int8_t *)("|05|"), /* pattern (now in PatrickStar content format) */
    1, /* depth */
    0, /* offset */
    CONTENT_RELATIVE|CONTENT_BUF_NORMALIZED, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
...
{
    (u_int8_t *)("|0B|"), /* pattern (now in PatrickStar content format) */
    1, /* depth */
    1, /* offset */
    CONTENT_RELATIVE|CONTENT_BUF_NORMALIZED, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
...
{
    (u_int8_t *)("@|FD|,4l<|CE 11 A8 93 08 00|+.|9C|m"), /* pattern (now in PatrickStar content format) */
    16, /* depth */
    29, /* offset */
