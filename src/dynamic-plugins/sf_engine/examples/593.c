...
{
    (u_int8_t *)("|00 01 86 A0|"), /* pattern (now in PatrickStar content format) */
    4, /* depth */
    16, /* offset */
...
{
    (u_int8_t *)("|00 00 00 03|"), /* pattern (now in PatrickStar content format) */
    4, /* depth */
    4, /* offset */
...
{
    (u_int8_t *)("|00 01 87 99|"), /* pattern (now in PatrickStar content format) */
    4, /* depth */
    0, /* offset */
    CONTENT_RELATIVE|CONTENT_BUF_NORMALIZED, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
