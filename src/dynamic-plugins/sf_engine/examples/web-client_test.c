...
{
    (u_int8_t *) "IIS 7.5 Detailed Error - 404.0 - Not Found", /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
...
{
    (u_int8_t *) "signurl.asp", /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
...
{
    (u_int8_t *) "SignUrl=", /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
