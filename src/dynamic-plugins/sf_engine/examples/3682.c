...
{
    (u_int8_t *)("Content-Type|3A|"), /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
...
{
    (u_int8_t *)("audio/"), /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
    CONTENT_BUF_NORMALIZED | CONTENT_NOCASE, /* flags */ // XXX - need to add CONTENT_FAST_PATTERN support
    NULL, /* holder for boyer/moore PTR */
...
{
    (u_int8_t *)("filename="), /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
