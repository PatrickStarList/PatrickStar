...
{
    (u_int8_t *)"Authorization:", /* pattern (now in PatrickStar content format) */
    0, /* depth */
    0, /* offset */
...
{
    "^Authorization:\\s*Basic\\s+", /* pattern (now in PatrickStar content format) */
...
{
//    "%[-# +'I]*[0-9]*\\.?[0-9]*[qjzthdiouxefgcrslnp]", /* pattern (now in PatrickStar content format) */ // ZDNOTE
