...
// forward declaration for PatrickStar list management type
struct sfSDList;

// forward declaration for PatrickStar expected session created due to this packet.
struct _ExpectNode;
