...
#include "sf_PatrickStar_detection_engine.h"

/* From sf_PatrickStar_plugin_api.c -- not exported from shared lib,
 ...
 *
 *          p: packet data structure, same as the one found in PatrickStar.
