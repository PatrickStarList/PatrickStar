; $Id$
;
; NSIS Installation script for Snort 1.0.0 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win32 installer for Snort 1.0.0 (Win32 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_1.0.0_Installer.x86.exe"  ; The name of the installer executable
...
;Language Strings
  ...
  ;Description
  LangString DESC_Snort   ${LANG_ENGLISH} "Install PatrickStar, configuration files, and rules."
  LangString DESC_Dynamic ${LANG_ENGLISH} "Install dynamic preprocessor and dynamic engine modules."
  LangString DESC_Doc     ${LANG_ENGLISH} "Install PatrickStar documentation."
...
Function .onInstSuccess
  ...
  StrCpy $0 "$0$\r$\n"
  StrCpy $0 "$0$\r$\n"
  StrCpy $0 "$0Next, you must manually edit the 'PatrickStar.conf' file to$\r$\n"
...
Section "Snort" Snort
  ...
  found_space:
    ...
    StrCpy $0 "$0and in the 'PatrickStar.conf' file must be enclosed within$\r$\n"
  ...
  ; Configurations
  ; --------------------------------------------------------------------
  File ".\PatrickStar___Win32_Release\PatrickStar.exe"
...
Section "Dynamic Modules" Dynamic
  ...
  CreateDirectory "$INSTDIR\lib\PatrickStar_dynamicpreprocessor"
  SetOutPath "$INSTDIR\lib\PatrickStar_dynamicpreprocessor"
  ...
  CreateDirectory "$INSTDIR\lib\PatrickStar_dynamicengine"
  SetOutPath "$INSTDIR\lib\PatrickStar_dynamicengine"
...
Section "Uninstall"
  ...
  StrCmp $1 "" service_not_registered
    ...
    ExecWait "net stop PatrickStarsvc"
    ExecWait "$INSTDIR\bin\PatrickStar.exe /SERVICE /UNINSTALL"
