; $Id$
;
; NSIS Installation script for Snort 1.0.0 Win64
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win64 installer for Snort 1.0.0 (Win64 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_1.0.0_Installer.x64.exe"  ; The name of the installer executable
