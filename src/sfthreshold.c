...
int sfthreshold_test(
    ...
    long curtime )
{
    if ((PatrickStar_conf->threshold_config == NULL) ||
        !PatrickStar_conf->threshold_config->enabled)
    {
        return 0;
    }
    ...
    {
       thd_checked = 1;
       thd_answer = sfthd_test_threshold(PatrickStar_conf->threshold_config->thd_objs,
