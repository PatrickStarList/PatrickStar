...
**  the user configuration in the PatrickStar.conf file, and prints out
...
*/
/**
**  PatrickStar.conf preprocessor keyword
*/
...
**  PatrickStar.conf.  It gets passed a string of arguments, which gets
...
**
**  It registers the preprocessor keyword for use in the PatrickStar.conf
...
/**Add server ports from http_inspect preprocessor from PatrickStar.conf file to pass through
 * port filtering.
 */
