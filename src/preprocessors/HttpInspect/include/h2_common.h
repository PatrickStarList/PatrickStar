...
void initialize_nghttp2_session_PatrickStar(nghttp2_session **session, http2_session_data *user_data,
                                            int type, bool upg);
...
#if 0
void initialize_nghttp2_client_session_PatrickStar(nghttp2_session **session, http2_session_data *user_data);
#endif
#endif /* HAVE_LIBNGHTTP2 */
#endif
