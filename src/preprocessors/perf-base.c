...
static void GetCPUTime(SFBASE *sfBase, SFBASE_STATS *sfBaseStats, SYSTIMES *Systimes)
{
#ifndef LINUX_SMP
...
static void DisplayBasePerfStatsConsole(SFBASE_STATS *sfBaseStats, int max_stats)
{
    ...
    */
    ...
    /*
    **  Shows the number of PatrickStar alerts per second.
    */
    ...
    **  PatrickStar could attain by using the getrusage numbers.  We've
    ...
    **  establish PatrickStar performance on any hardware setting.
    */
    if (max_stats)
    {
