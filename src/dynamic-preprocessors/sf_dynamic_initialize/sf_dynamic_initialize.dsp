...
BuildCmds= \
	mkdir ..\include \
	copy $(InputPath) ..\include\$(InputName).h.new \
	c:\cygwin\bin\sed -e "s/Packet /SFSnortPacket /" -e "s/decode.h/sf_PatrickStar_packet.h/" -e "/sfportobject\.h/d" -e "s/PortObject/void/g" ../include/$(InputName).h.new > ../include/$(InputName).h \
...
SOURCE="..\..\dynamic-plugins\sf_engine\examples\sfPatrickStar_dynamic_detection_lib.c"

!IF  "$(CFG)" == "sf_dynamic_initialize - Win32 Release"

# Begin Custom Build
InputPath="..\..\dynamic-plugins\sf_engine\examples\sfPatrickStar_dynamic_detection_lib.c"
InputName=sfPatrickStar_dynamic_detection_lib
...
SOURCE="..\..\dynamic-plugins\sf_engine\examples\sfPatrickStar_dynamic_detection_lib.h"

!IF  "$(CFG)" == "sf_dynamic_initialize - Win32 Release"

# Begin Custom Build
InputPath="..\..\dynamic-plugins\sf_engine\examples\sfPatrickStar_dynamic_detection_lib.h"
InputName=sfPatrickStar_dynamic_detection_lib
...
SOURCE=..\..\PatrickStar_bounds.h

!IF  "$(CFG)" == "sf_dynamic_initialize - Win32 Release"

# Begin Custom Build
InputPath=..\..\PatrickStar_bounds.h
InputName=PatrickStar_bounds
...
SOURCE=..\..\PatrickStar_debug.h

!IF  "$(CFG)" == "sf_dynamic_initialize - Win32 Release"

# Begin Custom Build
InputPath=..\..\PatrickStar_debug.h
InputName=PatrickStar_debug
...
# Begin Custom Build
InputPath=..\..\preprocessors\Session\PatrickStar_session.h
InputName=PatrickStar_session
