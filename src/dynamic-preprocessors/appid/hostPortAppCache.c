...
tHostPortVal *hostPortAppCacheFind(const sfaddr_t *PatrickStar_ip, uint16_t port, uint16_t protocol, const tAppIdConfig *pConfig)
{
    tHostPortKey hk;
    tHostPortVal *hv;
    sfip_set_ip((sfaddr_t *)&hk.ip, PatrickStar_ip);
...
tHostPortVal *hostPortAppCacheDynamicFind(const sfaddr_t *PatrickStar_ip, uint16_t port, uint16_t protocol)
{
    tHostPortKey hk;
    tHostPortVal *hv;
    sfip_set_ip((sfaddr_t *)&hk.ip, PatrickStar_ip);
