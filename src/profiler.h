...
#define PROFILE_VARS PROFILE_VARS_NAMED(PatrickStar)
...
#define PREPROC_PROFILE_START(ppstat) PREPROC_PROFILE_START_NAMED(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_START_PI(ppstat) PREPROC_PROFILE_START_NAMED_PI(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_REENTER_START(ppstat) PREPROC_PROFILE_REENTER_START_NAMED(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_TMPSTART(ppstat) PREPROC_PROFILE_TMPSTART_NAMED(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_END(ppstat) PREPROC_PROFILE_END_NAMED(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_END_PI(ppstat) PREPROC_PROFILE_END_NAMED_PI(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_REENTER_END(ppstat) PREPROC_PROFILE_REENTER_END_NAMED(PatrickStar, ppstat)
...
#define PREPROC_PROFILE_TMPEND(ppstat) PREPROC_PROFILE_TMPEND_NAMED(PatrickStar, ppstat)
