...
#define DECODE_NOT_IPV4_DGRAM_STR "(PatrickStar_decoder) WARNING: Not IPv4 datagram"
#define DECODE_IPV4_INVALID_HEADER_LEN_STR "(PatrickStar_decoder) WARNING: hlen < IP_HEADER_LEN"
#define DECODE_IPV4_DGRAM_LT_IPHDR_STR "(PatrickStar_decoder) WARNING: IP dgm len < IP Hdr len"
#define DECODE_IPV4OPT_BADLEN_STR      "(PatrickStar_decoder) WARNING: Ipv4 Options found with bad lengths"
#define DECODE_IPV4OPT_TRUNCATED_STR   "(PatrickStar_decoder) WARNING: Truncated Ipv4 Options"
#define DECODE_IPV4_DGRAM_GT_CAPLEN_STR "(PatrickStar_decoder) WARNING: IP dgm len > captured len"
#define DECODE_NOT_IPV6_DGRAM_STR      "(PatrickStar_decoder) WARNING: Not an IPv6 datagram"

#define DECODE_TCP_DGRAM_LT_TCPHDR_STR "(PatrickStar_decoder) WARNING: TCP packet len is smaller than 20 bytes"
#define DECODE_TCP_INVALID_OFFSET_STR "(PatrickStar_decoder) WARNING: TCP Data Offset is less than 5"
#define DECODE_TCP_LARGE_OFFSET_STR "(PatrickStar_decoder) WARNING: TCP Header length exceeds packet length"

#define DECODE_TCPOPT_BADLEN_STR      "(PatrickStar_decoder) WARNING: Tcp Options found with bad lengths"
#define DECODE_TCPOPT_TRUNCATED_STR   "(PatrickStar_decoder) WARNING: Truncated Tcp Options"
#define DECODE_TCPOPT_TTCP_STR        "(PatrickStar_decoder) WARNING: T/TCP Detected"
#define DECODE_TCPOPT_OBSOLETE_STR    "(PatrickStar_decoder) WARNING: Obsolete TCP Options found"
#define DECODE_TCPOPT_EXPERIMENT_STR  "(PatrickStar_decoder) WARNING: Experimental Tcp Options found"
#define DECODE_TCPOPT_WSCALE_INVALID_STR "(PatrickStar_decoder) WARNING: Tcp Window Scale Option found with length > 14"

#define DECODE_UDP_DGRAM_LT_UDPHDR_STR "(PatrickStar_decoder) WARNING: Truncated UDP Header"
#define DECODE_UDP_DGRAM_INVALID_LENGTH_STR "(PatrickStar_decoder) WARNING: Invalid UDP header, length field < 8"
#define DECODE_UDP_DGRAM_SHORT_PACKET_STR "(PatrickStar_decoder) WARNING: Short UDP packet, length field > payload length"
#define DECODE_UDP_DGRAM_LONG_PACKET_STR "(PatrickStar_decoder) WARNING: Long UDP packet, length field < payload length"

#define DECODE_ICMP_DGRAM_LT_ICMPHDR_STR "(PatrickStar_decoder) WARNING: ICMP Header Truncated"
#define DECODE_ICMP_DGRAM_LT_TIMESTAMPHDR_STR "(PatrickStar_decoder) WARNING: ICMP Timestamp Header Truncated"
#define DECODE_ICMP_DGRAM_LT_ADDRHDR_STR "(PatrickStar_decoder) WARNING: ICMP Address Header Truncated"
#define DECODE_IPV4_DGRAM_UNKNOWN_STR "(PatrickStar_decoder) WARNING: Unknown Datagram decoding problem"
#define DECODE_ARP_TRUNCATED_STR "(PatrickStar_decoder) WARNING: Truncated ARP"
#define DECODE_EAPOL_TRUNCATED_STR "(PatrickStar_decoder) WARNING: Truncated EAP Header"
#define DECODE_EAPKEY_TRUNCATED_STR "(PatrickStar_decoder) WARNING: EAP Key Truncated"
#define DECODE_EAP_TRUNCATED_STR "(PatrickStar_decoder) WARNING: EAP Header Truncated"
#define DECODE_BAD_PPPOE_STR "(PatrickStar_decoder) WARNING: Bad PPPOE frame detected"
#define DECODE_BAD_VLAN_STR "(PatrickStar_decoder) WARNING: Bad VLAN Frame"
#define DECODE_BAD_VLAN_ETHLLC_STR "(PatrickStar_decoder) WARNING: Bad LLC header"
#define DECODE_BAD_VLAN_OTHER_STR "(PatrickStar_decoder) WARNING: Bad Extra LLC Info"
#define DECODE_BAD_80211_ETHLLC_STR "(PatrickStar_decoder) WARNING: Bad 802.11 LLC header"
#define DECODE_BAD_80211_OTHER_STR "(PatrickStar_decoder) WARNING: Bad 802.11 Extra LLC Info"

#define DECODE_BAD_TRH_STR "(PatrickStar_decoder) WARNING: Bad Token Ring Header"
#define DECODE_BAD_TR_ETHLLC_STR "(PatrickStar_decoder) WARNING: Bad Token Ring ETHLLC Header"
#define DECODE_BAD_TR_MR_LEN_STR "(PatrickStar_decoder) WARNING: Bad Token Ring MRLENHeader"
#define DECODE_BAD_TRHMR_STR "(PatrickStar_decoder) WARNING: Bad Token Ring MR Header"

#define     DECODE_BAD_TRAFFIC_LOOPBACK_STR     "(PatrickStar decoder) WARNING: Bad Traffic Loopback IP"
#define     DECODE_BAD_TRAFFIC_SAME_SRCDST_STR  "(PatrickStar decoder) WARNING: Bad Traffic Same Src/Dst IP"

#ifdef GRE
#define DECODE_GRE_DGRAM_LT_GREHDR_STR "(PatrickStar decoder) WARNING: GRE header length > payload length"
#define DECODE_GRE_MULTIPLE_ENCAPSULATION_STR "(PatrickStar decoder) WARNING: Multiple encapsulations in packet"
#define DECODE_GRE_INVALID_VERSION_STR "(PatrickStar decoder) WARNING: Invalid GRE version"
#define DECODE_GRE_INVALID_HEADER_STR "(PatrickStar decoder) WARNING: Invalid GRE header"
#define DECODE_GRE_V1_INVALID_HEADER_STR "(PatrickStar decoder) WARNING: Invalid GRE v.1 PPTP header"
#define DECODE_GRE_TRANS_DGRAM_LT_TRANSHDR_STR "(PatrickStar decoder) WARNING: GRE Trans header length > payload length"
#endif  /* GRE */

#define DECODE_ICMP_ORIG_IP_TRUNCATED_STR "(PatrickStar_decoder) WARNING: ICMP Original IP Header Truncated"
#define DECODE_ICMP_ORIG_IP_VER_MISMATCH_STR "(PatrickStar_decoder) WARNING: ICMP version and Original IP Header versions differ"
#define DECODE_ICMP_ORIG_DGRAM_LT_ORIG_IP_STR "(PatrickStar_decoder) WARNING: ICMP Original Datagram Length < Original IP Header Length"
#define DECODE_ICMP_ORIG_PAYLOAD_LT_64_STR "(PatrickStar_decoder) WARNING: ICMP Original IP Payload < 64 bits"
#define DECODE_ICMP_ORIG_PAYLOAD_GT_576_STR "(PatrickStar_decoder) WARNING: ICMP Origianl IP Payload > 576 bytes"
#define DECODE_ICMP_ORIG_IP_WITH_FRAGOFFSET_STR "(PatrickStar_decoder) WARNING: ICMP Original IP Fragmented and Offset Not 0"

#define DECODE_IPV6_MIN_TTL_STR "(PatrickStar decoder) WARNING: IPv6 packet below TTL limit"
#define DECODE_IPV6_IS_NOT_STR "(PatrickStar decoder) WARNING: IPv6 header claims to not be IPv6"
#define DECODE_IPV6_TRUNCATED_EXT_STR "(PatrickStar decoder) WARNING: IPV6 truncated extension header"
#define DECODE_IPV6_TRUNCATED_STR "(PatrickStar decoder) WARNING: IPV6 truncated header"
#define DECODE_IPV6_DGRAM_LT_IPHDR_STR "(PatrickStar_decoder) WARNING: IP dgm len < IP Hdr len"
#define DECODE_IPV6_DGRAM_GT_CAPLEN_STR "(PatrickStar_decoder) WARNING: IP dgm len > captured len"

#define DECODE_IPV6_DST_ZERO_STR "(PatrickStar_decoder) WARNING: IPv6 packet with destination address ::0"
#define DECODE_IPV6_SRC_MULTICAST_STR "(PatrickStar_decoder) WARNING: IPv6 packet with multicast source address"
#define DECODE_IPV6_DST_RESERVED_MULTICAST_STR "(PatrickStar_decoder) WARNING: IPv6 packet with reserved multicast destination address"
#define DECODE_IPV6_BAD_OPT_TYPE_STR "(PatrickStar_decoder) WARNING: IPv6 header includes an undefined option type"
#define DECODE_IPV6_BAD_MULTICAST_SCOPE_STR "(PatrickStar_decoder) WARNING: IPv6 address includes an unassigned multicast scope value"
#define DECODE_IPV6_BAD_NEXT_HEADER_STR "(PatrickStar_decoder) WARNING: IPv6 header includes an invalid value for the \"next header\" field"
#define DECODE_IPV6_ROUTE_AND_HOPBYHOP_STR "(PatrickStar_decoder) WARNING: IPv6 header includes a routing extension header followed by a hop-by-hop header"
#define DECODE_IPV6_TWO_ROUTE_HEADERS_STR "(PatrickStar_decoder) WARNING: IPv6 header includes two routing extension headers"
#define DECODE_IPV6_DSTOPTS_WITH_ROUTING_STR "(PatrickStar_decoder) WARNING: IPv6 header has destination options followed by a routing header"
#define DECODE_ICMPV6_TOO_BIG_BAD_MTU_STR "(PatrickStar_decoder) WARNING: ICMPv6 packet of type 2 (message too big) with MTU field < 1280"
#define DECODE_ICMPV6_UNREACHABLE_NON_RFC_2463_CODE_STR "(PatrickStar_decoder) WARNING: ICMPv6 packet of type 1 (destination unreachable) with non-RFC 2463 code"
#define DECODE_ICMPV6_SOLICITATION_BAD_CODE_STR "(PatrickStar_decoder) WARNING: ICMPv6 router solicitation packet with a code not equal to 0"
#define DECODE_ICMPV6_ADVERT_BAD_CODE_STR "(PatrickStar_decoder) WARNING: ICMPv6 router advertisement packet with a code not equal to 0"
#define DECODE_ICMPV6_SOLICITATION_BAD_RESERVED_STR "(PatrickStar_decoder) WARNING: ICMPv6 router solicitation packet with the reserved field not equal to 0"
#define DECODE_ICMPV6_ADVERT_BAD_REACHABLE_STR "(PatrickStar_decoder) WARNING: ICMPv6 router advertisement packet with the reachable time field set > 1 hour"

#define DECODE_IPV6_TUNNELED_IPV4_TRUNCATED_STR "(PatrickStar_decoder) WARNING: IPV6 tunneled over IPv4, IPv6 header truncated, possible Linux Kernel attack"

#define DECODE_IP_MULTIPLE_ENCAPSULATION_STR "(PatrickStar_decoder) WARNING: Two or more IP (v4 and/or v6) encapsulation layers present"

#define DECODE_ESP_HEADER_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated Encapsulated Security Payload (ESP) header"

#define DECODE_IPV6_BAD_OPT_LEN_STR "(PatrickStar_decoder) WARNING: IPv6 header includes an option which is too big for the containing header"

#define DECODE_IPV6_UNORDERED_EXTENSIONS_STR "(PatrickStar_decoder) WARNING: IPv6 packet includes out-of-order extension headers"
#define DECODE_GTP_MULTIPLE_ENCAPSULATION_STR "(PatrickStar_decoder) WARNING: Two or more GTP encapsulation layers present"
#define DECODE_GTP_BAD_LEN_STR "(PatrickStar_decoder) WARNING: GTP header length is invalid"
#define DECODE_TCP_XMAS_STR "(PatrickStar_decoder) WARNING: XMAS Attack Detected"
#define DECODE_TCP_NMAP_XMAS_STR "(PatrickStar_decoder) WARNING: Nmap XMAS Attack Detected"

#define DECODE_DOS_NAPTHA_STR "(PatrickStar_decoder) WARNING: DOS NAPTHA Vulnerability Detected"
#define DECODE_SYN_TO_MULTICAST_STR "(PatrickStar_decoder) WARNING: Bad Traffic SYN to multicast address"
#define DECODE_ZERO_TTL_STR "(PatrickStar_decoder) WARNING: IPV4 packet with zero TTL"
#define DECODE_BAD_FRAGBITS_STR "(PatrickStar_decoder) WARNING: IPV4 packet with bad frag bits (Both MF and DF set)"
#define DECODE_UDP_IPV6_ZERO_CHECKSUM_STR "(PatrickStar_decoder) WARNING: Invalid IPv6 UDP packet, checksum zero"
#define DECODE_IP4_LEN_OFFSET_STR "(PatrickStar_decoder) WARNING: IPV4 packet frag offset + length exceed maximum"
#define DECODE_IP4_SRC_THIS_NET_STR "(PatrickStar_decoder) WARNING: IPV4 packet from 'current net' source address"
#define DECODE_IP4_DST_THIS_NET_STR "(PatrickStar_decoder) WARNING: IPV4 packet to 'current net' dest address"
#define DECODE_IP4_SRC_MULTICAST_STR "(PatrickStar_decoder) WARNING: IPV4 packet from multicast source address"
#define DECODE_IP4_SRC_RESERVED_STR "(PatrickStar_decoder) WARNING: IPV4 packet from reserved source address"
#define DECODE_IP4_DST_RESERVED_STR "(PatrickStar_decoder) WARNING: IPV4 packet to reserved dest address"
#define DECODE_IP4_SRC_BROADCAST_STR "(PatrickStar_decoder) WARNING: IPV4 packet from broadcast source address"
#define DECODE_IP4_DST_BROADCAST_STR "(PatrickStar_decoder) WARNING: IPV4 packet to broadcast dest address"
#define DECODE_ICMP4_DST_MULTICAST_STR "(PatrickStar_decoder) WARNING: ICMP4 packet to multicast dest address"
#define DECODE_ICMP4_DST_BROADCAST_STR "(PatrickStar_decoder) WARNING: ICMP4 packet to broadcast dest address"
#define DECODE_ICMP4_TYPE_OTHER_STR "(PatrickStar_decoder) WARNING: ICMP4 type other"
#define DECODE_TCP_BAD_URP_STR "(PatrickStar_decoder) WARNING: TCP urgent pointer exceeds payload length or no payload"
#define DECODE_TCP_SYN_FIN_STR "(PatrickStar_decoder) WARNING: TCP SYN with FIN"
#define DECODE_TCP_SYN_RST_STR "(PatrickStar_decoder) WARNING: TCP SYN with RST"
#define DECODE_TCP_MUST_ACK_STR "(PatrickStar_decoder) WARNING: TCP PDU missing ack for established session"
#define DECODE_TCP_NO_SYN_ACK_RST_STR "(PatrickStar_decoder) WARNING: TCP has no SYN, ACK, or RST"
#define DECODE_ETH_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated eth header"
#define DECODE_IP4_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated IP4 header"
#define DECODE_ICMP4_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated ICMP4 header"
#define DECODE_ICMP6_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated ICMP6 header"
#define DECODE_IP4_MIN_TTL_STR "(PatrickStar decoder) WARNING: IPV4 packet below TTL limit"
#define DECODE_IP6_ZERO_HOP_LIMIT_STR "(PatrickStar decoder) WARNING: IPV6 packet has zero hop limit"
#define DECODE_IP4_DF_OFFSET_STR "(PatrickStar_decoder) WARNING: IPV4 packet both DF and offset set"
#define DECODE_ICMP6_TYPE_OTHER_STR "(PatrickStar_decoder) WARNING: ICMP6 type not decoded"
#define DECODE_ICMP6_DST_MULTICAST_STR "(PatrickStar_decoder) WARNING: ICMP6 packet to multicast address"
#define DECODE_TCP_SHAFT_SYNFLOOD_STR "(PatrickStar_decoder) WARNING: DDOS shaft synflood"
#define DECODE_ICMP_PING_NMAP_STR "(PatrickStar_decoder) WARNING: ICMP PING NMAP"
#define DECODE_ICMP_ICMPENUM_STR "(PatrickStar_decoder) WARNING: ICMP icmpenum v1.1.1"
#define DECODE_ICMP_REDIRECT_HOST_STR "(PatrickStar_decoder) WARNING: ICMP redirect host"
#define DECODE_ICMP_REDIRECT_NET_STR "(PatrickStar_decoder) WARNING: ICMP redirect net"
#define DECODE_ICMP_TRACEROUTE_IPOPTS_STR "(PatrickStar_decoder) WARNING: ICMP traceroute ipopts"
#define DECODE_ICMP_SOURCE_QUENCH_STR "(PatrickStar_decoder) WARNING: ICMP Source Quench"
#define DECODE_ICMP_BROADSCAN_SMURF_SCANNER_STR "(PatrickStar_decoder) WARNING: Broadscan Smurf Scanner"
#define DECODE_ICMP_DST_UNREACH_ADMIN_PROHIBITED_STR "(PatrickStar_decoder) WARNING: ICMP Destination Unreachable Communication Administratively Prohibited"
#define DECODE_ICMP_DST_UNREACH_DST_HOST_PROHIBITED_STR "(PatrickStar_decoder) WARNING: ICMP Destination Unreachable Communication with Destination Host is Administratively Prohibited"
#define DECODE_ICMP_DST_UNREACH_DST_NET_PROHIBITED_STR "(PatrickStar_decoder) WARNING: ICMP Destination Unreachable Communication with Destination Network is Administratively Prohibited"
#define DECODE_IP_OPTION_SET_STR "(PatrickStar_decoder) WARNING: MISC IP option set"
#define DECODE_UDP_LARGE_PACKET_STR "(PatrickStar_decoder) WARNING: MISC Large UDP Packet"
#define DECODE_TCP_PORT_ZERO_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC TCP port 0 traffic"
#define DECODE_UDP_PORT_ZERO_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC UDP port 0 traffic"
#define DECODE_IP_RESERVED_FRAG_BIT_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC IP reserved bit set"
#define DECODE_IP_UNASSIGNED_PROTO_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC Unassigned/Reserved IP protocol"
#define DECODE_IP_BAD_PROTO_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC Bad IP protocol"
#define DECODE_ICMP_PATH_MTU_DOS_STR "(PatrickStar_decoder) WARNING: ICMP PATH MTU denial of service attempt"
#define DECODE_ICMP_DOS_ATTEMPT_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC linux ICMP header dos attempt"
#define DECODE_IPV6_ISATAP_SPOOF_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC ISATAP-addressed IPv6 traffic spoofing attempt"
#define DECODE_PGM_NAK_OVERFLOW_STR "(PatrickStar_decoder) WARNING: BAD-TRAFFIC PGM nak list overflow attempt"
#define DECODE_IGMP_OPTIONS_DOS_STR "(PatrickStar_decoder) WARNING: DOS IGMP IP Options validation attempt"
#define DECODE_IP6_EXCESS_EXT_HDR_STR "(PatrickStar_decoder) WARNING: too many IP6 extension headers"
#define DECODE_ICMPV6_UNREACHABLE_NON_RFC_4443_CODE_STR "(PatrickStar_decoder) WARNING: ICMPv6 packet of type 1 (destination unreachable) with non-RFC 4443 code"
#define DECODE_IPV6_BAD_FRAG_PKT_STR "(PatrickStar_decoder) WARNING: bogus fragmentation packet. Possible BSD attack"
#define DECODE_ZERO_LENGTH_FRAG_STR "(PatrickStar_decoder) WARNING: fragment with zero length"
#define DECODE_ICMPV6_NODE_INFO_BAD_CODE_STR "(PatrickStar_decoder) WARNING: ICMPv6 node info query/response packet with a code greater than 2"
#define DECODE_IPV6_ROUTE_ZERO_STR "(PatrickStar decoder) WARNING: IPV6 routing type 0 extension header"
#define DECODE_ERSPAN_HDR_VERSION_MISMATCH_STR "(PatrickStar_decoder) WARNING: ERSpan Header version mismatch"
#define DECODE_ERSPAN2_DGRAM_LT_HDR_STR "(PatrickStar_decoder) WARNING: captured < ERSpan Type2 Header Length"
#define DECODE_ERSPAN3_DGRAM_LT_HDR_STR "(PatrickStar_decoder) WARNING: captured < ERSpan Type3 Header Length"
#define DECODE_AUTH_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated authentication header"
#define DECODE_AUTH_HDR_BAD_LEN_STR "(PatrickStar_decoder) WARNING: authentication header bad length"
#define DECODE_FPATH_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated FabricPath header"
#define DECODE_CISCO_META_HDR_TRUNC_STR "(PatrickStar_decoder) WARNING: truncated Cisco Metadata header"
#define DECODE_CISCO_META_HDR_OPT_LEN_STR "(PatrickStar_decoder) WARNING: Invalid Cisco Metadata option length"
#define DECODE_CISCO_META_HDR_OPT_TYPE_STR "(PatrickStar_decoder) WARNING: Invalid Cisco Metadata option type"
#define DECODE_CISCO_META_HDR_SGT_STR "(PatrickStar_decoder) WARNING: Invalid Cisco Metadata SGT"
...
#define DECODE_BAD_MPLS_STR "(PatrickStar_decoder) WARNING: Bad MPLS Frame"
#define DECODE_BAD_MPLS_LABEL0_STR "(PatrickStar_decoder) WARNING: MPLS Label 0 Appears in Nonbottom Header"
#define DECODE_BAD_MPLS_LABEL1_STR "(PatrickStar_decoder) WARNING: MPLS Label 1 Appears in Bottom Header"
#define DECODE_BAD_MPLS_LABEL2_STR "(PatrickStar_decoder) WARNING: MPLS Label 2 Appears in Nonbottom Header"
#define DECODE_BAD_MPLS_LABEL3_STR "(PatrickStar_decoder) WARNING: MPLS Label 3 Appears in Header"
#define DECODE_MPLS_RESERVEDLABEL_STR "(PatrickStar_decoder) WARNING: MPLS Label 4, 5,.. or 15 Appears in Header"
#define DECODE_MPLS_LABEL_STACK_STR "(PatrickStar_decoder) WARNING: Too Many MPLS headers"
#define DECODE_MULTICAST_MPLS_STR "(PatrickStar_decoder) WARNING: Multicast MPLS traffic detected"

#define DECODE_DECODING_DEPTH_EXCEEDED_STR "(PatrickStar_decoder) WARNING: Too many levels for decoding"
